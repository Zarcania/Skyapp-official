// Composant Gestion des Équipes - Drag & Drop Simple
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      ...
      <div className="mb-8 text-center">
        ...
        <div className="flex items-center justify-center gap-4 mb-2">
          ...
          <button
            onClick={loadData}
            disabled={loading}
            className="p-2 rounded-lg bg-white hover:bg-gray-100 border border-gray-300 shadow-sm transition-all disabled:opacity-50"
        ...
        <p className="text-gray-600 mt-2 text-lg">Glissez-déposez les collaborateurs vers les chefs d'équipe</p>
      </div>
      ...
      <div className="grid grid-cols-12 gap-6 max-w-7xl mx-auto">
        ...
        <div className="col-span-8 space-y-4">
          <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-gray-200">
            <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
              ...
              <span className="ml-auto text-sm font-normal bg-gray-100 text-gray-800 px-3 py-1 rounded-full border border-gray-300">
            ...
            {teamLeaders.length === 0 ? (
              <div className="text-center py-16">
                <div className="w-24 h-24 bg-gray-200 rounded-full flex items-center justify-center mx-auto mb-4 border-2 border-gray-300">
                  <Users className="w-12 h-12 text-gray-500" />
                </div>
                <p className="text-gray-700 text-lg font-semibold">Aucun chef d'équipe</p>
                <p className="text-gray-500 text-sm mt-1">Créez des chefs d'équipe pour commencer</p>
              </div>
            ) : (
                ...
                {teamLeaders.map(leader => {
                  ...
                  return (
                    <div
                      ...
                      className={`relative overflow-hidden border-2 border-dashed rounded-2xl p-5 transition-all duration-300 shadow-sm hover:shadow-lg ${
                        isMax 
                    ...
                    >
                      ...
                      <div className="relative flex items-center justify-between mb-4">
                        ...
                        <div className="flex items-center gap-2">
                          {isMax && (
                            <div className="flex items-center gap-2 bg-gray-200 text-gray-900 text-sm font-bold px-3 py-2 rounded-xl border-2 border-gray-400">
                          ...
                          <button
                            ...
                            className="p-2 hover:bg-red-100 rounded-lg text-red-600 transition-all duration-200"
                      ...
                      {(leader.collaborators || []).length > 0 && (
                        <div className="relative grid grid-cols-2 gap-3">
                          {leader.collaborators.map(collab => (
                            <div
                              key={collab.id}
                              className="group flex items-center justify-between bg-white p-3 rounded-xl border-2 border-gray-300 hover:border-black shadow-sm hover:shadow-md transition-all duration-200"
                            >
                              <div className="flex items-center gap-3 flex-1 min-w-0">
                                <div className="w-9 h-9 bg-gray-800 rounded-lg flex items-center justify-center text-white font-bold text-sm">
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  {collab.role === 'ADMIN' && (
                                    <span className="inline-block text-xs bg-gray-200 text-gray-900 px-2 py-0.5 rounded-full font-bold border border-gray-400 mt-0.5">
                                      ADMIN
                                    </span>
                                  )}
                                </div>
                              ...
                              <button
                                ...
                                className="opacity-0 group-hover:opacity-100 p-2 hover:bg-gray-200 rounded-lg text-gray-900 transition-all duration-200 transform group-hover:scale-110"
                      ...
                      {(leader.collaborators || []).length === 0 && (
                        <div className="relative text-center py-8">
                          <div className="w-16 h-16 bg-gray-100 rounded-2xl flex items-center justify-center mx-auto mb-3 border-2 border-gray-300">
                            <Users className="w-8 h-8 text-gray-500" />
                          </div>
                          <p className="text-gray-500 text-sm font-medium">Glissez un collaborateur ici</p>
                          <p className="text-gray-400 text-xs mt-1">Drag & Drop pour assigner</p>
                        </div>
                      )}
                    </div>
                  );
        ...
        <div className="col-span-4">
          <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-6 border-2 border-gray-200">
            ...
            {unassignedCollaborators.length === 0 ? (
              <div className="text-center py-16">
                ...
                <p className="text-gray-700 font-semibold">Tout est assigné !</p>
                <p className="text-gray-500 text-sm mt-1">Tous les collaborateurs ont une équipe</p>
              </div>
            ) : (
              <div>
                <div className="mb-4 flex items-center gap-3 bg-gray-100 border-2 border-gray-400 p-3 rounded-xl">
                ...
                <div className="space-y-3 max-h-[500px] overflow-y-auto pr-2 pt-2 custom-scrollbar">
                  {unassignedCollaborators.map(collab => (
                    <div
                      key={collab.id}
                      draggable
                      onDragStart={(e) => handleDragStart(e, collab)}
                      className="group relative p-4 bg-white border-2 border-gray-400 rounded-xl cursor-move hover:bg-gray-50 hover:border-black hover:shadow-xl hover:-translate-y-1 transition-all duration-200"
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {collab.role === 'ADMIN' && (
                            <span className="inline-block text-xs bg-gray-200 text-gray-900 px-2 py-0.5 rounded-full font-bold border border-gray-400 mt-1">
                              ADMIN
                            </span>
                          )}
                        </div>
                ...
                <div className="mt-5 p-4 bg-gray-100 rounded-xl border-2 border-gray-300">
                  <div className="flex gap-3">
                    <span className="text-2xl">💡</span>
                    <div className="flex-1">
                      <p className="text-gray-900 font-bold text-sm">Astuce</p>
